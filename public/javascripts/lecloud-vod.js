...
var videoSdkTool = function () {
    ...
    function getBrowser(ua) {
        var config = [{ name: "ie", test: /msie/ }, { name: "opera", test: /opera/ }, { name: "firefox", test: /firefox/ }, { name: "safari", test: /safari.*(?!chrome)/ }, { name: "chrome", test: /chrome/ }, { name: "wph", test: /windows phone/ }, { name: "ps", test: /playstation/ }, { name: "uc", test: /ucbrowser|ucweb/ }, { name: "ps", test: /playstation/ }, { name: "xiaomi", test: /xiaomi/ }, { name: "qq", test: /qqbrowser/ }, { name: "weixin", test: /micromessenger/ }, { name: "360", test: /360browser/ }, { name: "baidu", test: /baidu/ }, { name: "qqwebview", test: / qq/ }, { name: "sougou", test: /sougou/ }, { name: "liebao", test: /liebaofast/ }, { name: "letv", test: /eui browser/ }];
        var br = "un";
    ...
    function getDevice(ua) {
        var config = [{ name: "wph", test: /windows phone/ }, { name: "ipad", test: /ipad/ }, { name: "iphone", test: /iphone/ }, { name: "androidPad", test: /(?!.*mobile)android/ }, { name: "androidPhone", test: /android.*mobile/ }, { name: "android", test: /android/ }, { name: "pc", test: /windows/ }, { name: "mac", test: /macintosh|mac os x/ }];
        for (var i = 0; i < config.length; i++) {
            var item = config[i];
            if (item.test.test(ua)) {
                return item.name;
    ...
    function getVersion(ua) {
        var browser = {};
        var s;
        (s = ua.match(/msie ([\d.]+)/)) ? browser.msie = s[1] : (s = ua.match(/firefox\/([\d.]+)/)) ? browser.firefox = s[1] : (s = ua.match(/360browser/)) ? browser.b360 = s[1] ? s[1] : '-' : (s = ua.match(/qqbrowser\/([\d.]+)/)) ? browser.bqq = s[1] : (s = ua.match(/ucbrowser\/([\d.]+)/)) ? browser.buc = s[1] : (s = ua.match(/baidubrowser\/([\d.]+)/)) ? browser.bbaidu = s[1] : (s = ua.match(/sogoumobilebrowser\/([\d.]+)/)) ? browser.bsgm = s[1] : (s = ua.match(/liebaofast\/([\d.]+)/)) ? browser.blbfast = s[1] : (s = ua.match(/mb2345browser\/([\d.]+)/)) ? browser.b2345 = s[1] : (s = ua.match(/4g explorer\/([\d.]+)/)) ? browser.b4g = s[1] : (s = ua.match(/huohoubrowser\/([\d.]+)/)) ? browser.bhuohou = s[1] : (s = ua.match(/maxthon[\/ ]([\d.]+)/)) ? browser.maxthon = s[1] : (s = ua.match(/(opera)|(opr)\/([\d.]+)/)) ? browser.opera = s[3] : (s = ua.match(/chrome\/([\d.]+)/)) ? browser.chrome = s[1] : (s = ua.match(/version\/([\d.]+).*safari/)) ? browser.safari = s[1] : browser.other = '-';
        var version = "";
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_SOTool__ = __webpack_require__(6);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-11
    ...
    Class.prototype = {
        ...
        * */
        addEventListener: function (type, handler, handlerThis, priority) {
            ...
            if (_this.EventMap.hasOwnProperty(type)) {} else {
                _this.EventMap[type] = [];
            }
...
var UiTool = {
    ...
    preventDefault: function (ev) {
        if (ev) ev.preventDefault();else window.event.returnValue = false;
    },
    ...
    drag: function (o, opt) {
        var SupportsTouches = "createTouch" in document,
            StartEvent = UiTool.turnEvent("mousedown"),
            //支持触摸式使用相应的事件替代
        ...
        o['on' + StartEvent] = function (e) {
            ...
            function mouseDragUp() {
                if (o.releaseCapture) o.releaseCapture();else if (window.captureEvents) window.captureEvents(Event.MOUSEMOVE | Event.MOUSEUP);
...
var WIN = window,
    DC = document;
var ApiList = ["playNewId", "getVideoSetting", "getVideoTime", "pauseVideo", "resumeVideo", "seekTo", "replayVideo", "closeVideo", "setVolume", "shutDown", "startUp", "getBufferPercent", "setDefinition", "getDefinition", "getDefaultDefinition", "getDefinitionList", "getDefList", "setVideoPercent", "getVideoPercent", "setVideoScale", "getVideoScale", "resetVideoScale", "fullVideoScale", "setVideoRect", "getLoadPercent", "getDownloadSpeed", "getPlayRecord", "getPlayState", "setVideoColor", "getVideoColor", "getVersion", "setAutoReplay", "feedback", "getLog", "getServerTime", "setTipInfo", "setPlayerInfo", "setHorseRaceLampInfo", "barrageInput", "barrageStop", "barrageStart", "barrageResume", "barragePause", "callFlash", "setPoint", "removePoint", "setPlaybackRate", "setFullScreen", "setX5FullScreen"];
...
var GlobalHandler = function () {
    ...
    return {
        ...
        def2Type: function (type, obj) {
            //rate to vtype,type=rate,obj={rate:vtype}
        ...
        initTypeDefObj: function (arr, obj) {
            //arr=服务器返回的vtype,obj={rate:vtype}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_UiTool__ = __webpack_require__(7);
                ...
                case "canvas":
                    ...
                    if (renderSubtype == "img") {
                        if (!this.renderCanvas) {
                            var imgRenderArr = __WEBPACK_IMPORTED_MODULE_3__common_videoTool__["a" /* default */].split(renderData, ";", 3),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_LoadEvent__ = __webpack_require__(5);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-11
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vsbf_js_common_SOTool__ = __webpack_require__(6);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 16-7-4
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__ErrCode__ = __webpack_require__(9);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-11
...
var CloudMmsProxy = function () {
    ...
    cloudVodProxy.prototype.getRequestList = function () {
        var timeout = 5000,
            ...
            ipList = [],
            ////106.39.244.239,111.206.211.221,223.95.79.18
    ...
    cloudVodProxy.prototype.loadCmp = function (data, arg) {
        ...
        if (data.code == 0) {
            ...
            } else if (data.videoinfo.hasOwnProperty("sspAd")) {
                //ssp
                var sspAd = {};
            ...
            for (var i = 0; i < data.videoinfo.medialist.length; i++) {
                var key = "",
                    item = data.videoinfo.medialist[i];
            ...
            if (data.code == "10071") {
                ...
                this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_6__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_7__ErrCode__["a" /* default */].VOD_MMSID_ANALY, message: data.message }, arg]));
            }
        }
    };
    ...
    cloudVodProxy.prototype.loadError = function (data, arg) {
        if (this.isClose) return;
        this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_6__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_7__ErrCode__["a" /* default */].VOD_CONFIG_IO }, arg]));
    };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vsbf_js_common_UiTool__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vsbf_js_common_SOTool__ = __webpack_require__(6);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-11
...
var BlH5Player = function () {
    ...
    h5player.prototype.initPlugin = function () {
        __WEBPACK_IMPORTED_MODULE_3__vsbf_js_common_SOTool__["a" /* default */].setPluginStack([{ name: "ErrorInfo", url: "//{domain}/p/{LANG}/plugin/errorRender.js" }, { name: "FeedbackInfo", url: "//{domain}/p/{LANG}/plugin/feedbackRender.js" }, { name: "PanoRender", url: "//{domain}/p/{LANG}/plugin/panoRender1.2.js" }, { name: "Ad", url: "//{domain}/p/{LANG}/plugin/a.js" }, { name: "ssp", url: "//{domain}/p/{LANG}/plugin/ssp.js" }, { name: "lang.message.plugin.vod", url: "//{domain}/p/{LANG}/plugin/lang/lang_vod.js" }], this.model.config.lang);
        //设置预加载的模块
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__event_MediaEvent__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__event_AdEvent__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__model_ErrCode__ = __webpack_require__(9);
    ...
    h5player.prototype.videoHandler = function (e) {
        ...
        switch (e.args[1]) {
            case __WEBPACK_IMPORTED_MODULE_13__event_PlayEvent__["a" /* default */].VIDEO_AUTH_VALID:
                if (m.videoplugin.getPlayerType() == "pano" && !m.checkPano()) return;
                m.canplay = true;
                m.setupAdplugin();
                break;
...
var H5Sdk = function () {
    ...
    sdk.prototype.getVideoSetting = function () {
        ...
        var model = __WEBPACK_IMPORTED_MODULE_1__common_videoTool__["a" /* default */].clone(this._pl.model.videoSetting),
            result = {};
...
var Model = function () {
    ...
    function SystemData() {
        //pc 表示系统是否在pc上运行
        var keys = ["mac", "nt", "os", "osv", "app", "bd", "xh", "ro", "cs", "ssid", "lo", "la"],
            me = this;
        for (var i = 0; i < keys.length; i++) {
            this[keys[i]] = "";
        }
    ...
    function VideoSetting() {
        var option = ["title", "duration", "volume", "definition", "defaultDefinition", "fullscreen", "percent", "time", "url", "videoWidth", "videoHeight"],
            me = this;
        for (var i = 0; i < option.length; i++) {
            this[option[i]] = "";
        }
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_UiTool__ = __webpack_require__(7);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 16-5-6
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__event_MediaEvent__ = __webpack_require__(8);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_ClassTool__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_UiTool__ = __webpack_require__(7);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__event_MediaEvent__ = __webpack_require__(8);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__core_view_display_DisplayObject__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__core_SkinRender__ = __webpack_require__(42);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-16
...
var SkinPlayer = function () {
    ...
    skinPlayer.prototype.setUp = function (option, el, outEl) {
        //;border:1px solid blue;
        var tpl = '<div id="#{video}" style="left:0px;top:0px;position: absolute;width:{width};height:{height};z-index:1;display: block;background-color: #000000;overflow:hidden"></div>' + '<div id="#{skin}" style="left:0px;top:0px;position: relative;width:{width};height:{height};z-index:2;overflow: hidden;"></div>' + '<div id="#{error}" style="left:0px;top:0px;position: absolute;width:{width};height:{height};z-index:3;overflow: hidden;display:none;"></div>';
        var width = "100%";
        var height = "100%";
        ...
        m.skin = new __WEBPACK_IMPORTED_MODULE_11__core_view_display_DisplayObject__["a" /* default */](m.el);
    ...
    * */
    skinPlayer.prototype.load = function (config) {
        ...
        if (!m.model.config.skinnable) {
            ...
            m.dispatchEvent(new __WEBPACK_IMPORTED_MODULE_5__core_Event__["a" /* default */](__WEBPACK_IMPORTED_MODULE_10__event_LoadEvent__["a" /* default */].LOADCMP));
        } else {
        ...
        for (var i = 0; i < styleArr.length; i++) {
            if (!config[styleArr[i]]) {
                if (config.pageControls) {
                    __WEBPACK_IMPORTED_MODULE_12__core_SkinRender__["a" /* default */]["setMedia" + styleArr[i]]("", false);
                } else {
                    __WEBPACK_IMPORTED_MODULE_12__core_SkinRender__["a" /* default */]["setMedia" + styleArr[i]](className, false);
                }
            }
        }
...
var SkinRender = {
    ...
    setPlayerCss: function (id) {
        //播放器全局设置,防止外部css污染
        var videoCss = '{id} img{' + 'width: auto !important;' + 'height: auto !important;' + '}';
        if (id != "") {
            id = "." + id + " ";
        }
    ...
    setMediacontrols: function (id, f) {
        var videoCss = '{id}video::-webkit-media-controls-enclosure,' + '{id}video::-webkit-media-controls {' + 'display: {dislay} !important;' + '}';
        if (id != "") {
            id = "." + id + " ";
        }
        videoCss = videoCss.replace(/{id}/g, id);
    ...
    setMediafullscreen: function (id, f) {
        var videoCss = '{id}video::-webkit-media-controls-fullscreen-button {' + 'display: {dislay} !important;' + '}';
        if (id != "") {
            id = "." + id + " ";
        }
        videoCss = videoCss.replace(/{id}/g, id);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__event_MediaEvent__ = __webpack_require__(8);
    ...
    videoPlayer.prototype.playVideo = function (t) {
        if (this.getPlayerType() == "pano") {
            if (!__WEBPACK_IMPORTED_MODULE_7__common_videoTool__["a" /* default */].checkPano()) {
                this.facade.dispatchEvent(new __WEBPACK_IMPORTED_MODULE_8__core_Event__["a" /* default */](__WEBPACK_IMPORTED_MODULE_9__event_PlayEvent__["a" /* default */].EVENT, __WEBPACK_IMPORTED_MODULE_9__event_PlayEvent__["a" /* default */].VIDEO_INFO, [{ code: 490, message: "该设备还不支持3d功能,建议使用windows和安卓系统下的谷歌浏览器体验该功能" }]));
                return;
            }
        }
    ...
    videoPlayer.prototype.mediaHandler = function (e) {
        switch (e.args[1]) {
            ...
            case MediaEvent.PLAYING:
                ...
                if (this.model.playType == "vod" && this.model.videoSetting.needbuy == 0 && this.model.videoSetting.duration > 600000) {
                    //大于6分钟的视频
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_videoTool__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__model_ErrCode__ = __webpack_require__(9);
...
var H5SamplePlayer = function () {
    ...
    samplePlayer.prototype.setUp = function (option, outEl) {
        ...
        var id = "LecoudPlayer" + new Date().getTime() + "" + videoIndex,
            html = '<div id="v{id}" style="left:0px;top:0px;width:100%;height:100%;display: block;position: relative;">' + '<video  id="{id}" controls="controls"  style="width:100%;height:100%;font-size: 12px;"></video>' + '</div>'; ////; border:1px solid red;;border:1px solid yellow; border:1px solid yellow;border:1px solid red;object-fit:scale-down !important;border:1px solid yellow;border:1px solid red;
        ...
        for (var i = 0; i < paramsList.length; i++) {
            if (option.hasOwnProperty(paramsList[i])) {
                if (paramsList[i] == "width" || paramsList[i] == "height") {} else {
    ...
    samplePlayer.prototype.rotateVideo = function (t) {
        ...
        if (m.videoBox.lastElementChild.tagName.toLowerCase() == "canvas") {
            //全景
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_Class__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_videoTool__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_MediaEvent__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__model_ErrCode__ = __webpack_require__(9);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-9-10
    ...
    basePlayer.prototype.onPlayEmptyHandler = function () {
        ...
        if (m.startPlay && m.playState != PlatState.EMPTY) {
            if (m.playState != PlatState.SEEK) {
                ...
                m.emptyST = setTimeout(function () {
                    m.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_3__event_MediaEvent__["a" /* default */].EVENT, __WEBPACK_IMPORTED_MODULE_3__event_MediaEvent__["a" /* default */].BUFFEREMPTY, m.getTime()));
                }, m.emptyDelay);
            } else {
                m.playState = PlatState.EMPTY;
...
var watermask = function () {
    ...
    * */
    watermask.prototype._renderWater = function (canvas, data) {
        ...
        if (!videoRect.hasMetadata) return;
        if (this.isPano()) {
            var xScale = 1;
            var yScale = 1;
        } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_videoTool__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_Event__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__event_LoadEvent__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ErrCode__ = __webpack_require__(9);
    ...
    cloudVodProxy.prototype.loadCmp = function (data, arg) {
        ...
        if (data.status == 200) {
            if (data.ercode = "0") {
                ...
                this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_3__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_4__ErrCode__["a" /* default */].GSLB_ANALY, message: "调度错误：" + data.ercode, errInfo: "url:" + this.getUrl() + " respponse:" + __WEBPACK_IMPORTED_MODULE_2__common_jsonTool__["a" /* default */].jsonToString(data) }, arg]));
            }
        } else {
            this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_3__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_4__ErrCode__["a" /* default */].GSLB_ANALY, message: "调度错误" }, arg]));
        }
    };
    cloudVodProxy.prototype.loadError = function (data, arg) {
        if (this.isClose) return;
        this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_3__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_4__ErrCode__["a" /* default */].GSLB_IO, message: __WEBPACK_IMPORTED_MODULE_5__blive_model_message_Message__["a" /* default */].GSLB_IO, errInfo: "url:" + this.getUrl() }, arg]));
    };
    return cloudVodProxy;
}();
    ...
    autoLoader.prototype = {
        load: function (arr, success, fail, handlerThis) {
            ...
            var startLoad = function () {
                // [{url,timeout,maxCount,retryTime}]
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_SOTool__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_ClassTool__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_Control__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__common_videoTool__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_Event__ = __webpack_require__(3);
...
var AdCtrl = function () {
    ...
    adCtrl.prototype.startLeAd = function () {
        ...
        } else if (this.model.videoSetting.hasOwnProperty("sspAd")) {
            //ssp
    ...
    adCtrl.prototype.initAd = function (mediaplayer, option) {
        ...
        if (_this.model.videoSetting.hasOwnProperty("ark") && typeof H5AD != 'undefined' && typeof H5AD == 'function') {
            _this.H5AD = new H5AD();
        } else if (typeof leH5AD != 'undefined' && typeof leH5AD.initH5 == 'function') {
            //ssp
    ...
    adCtrl.prototype.destroy = function () {
        var m = this;
        if (m.player) {
            if (!m.model.videoSetting.hasOwnProperty("ark") && m.model.videoSetting.hasOwnProperty("sspAd")) {
                //ssp
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__vsbf_js_event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__vsbf_js_model_ErrCode__ = __webpack_require__(9);
    ...
    modelvod.prototype.setUp = function (option, el) {
        if (!this.model.config.hasOwnProperty("url")) {
            if (option.hasOwnProperty("uu") && option.hasOwnProperty("vu") && !!option.uu && !!option.vu) {
                ...
                this.dispatchEvent(new __WEBPACK_IMPORTED_MODULE_4__vsbf_js_core_Event__["a" /* default */](__WEBPACK_IMPORTED_MODULE_2__vsbf_js_event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_3__vsbf_js_model_ErrCode__["a" /* default */].PARAMS }]));
                return;
            }
        } else {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__event_LoadEvent__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__ErrCode__ = __webpack_require__(9);
/**
 * Created with JetBrains WebStorm.
 * User: xuyafeng
 * Date: 15-12-3
...
var CloudVodProxy = function () {
    ...
    cloudVodProxy.prototype.loadCmp = function (data, arg) {
        ...
        if (data.code == 0) {
            ...
            if (data.code == "10071") {
                ...
                this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_7__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_8__ErrCode__["a" /* default */].VOD_MMSID_ANALY, message: data.message }, //data.message
                arg]));
            }
        }
    };
    ...
    cloudVodProxy.prototype.loadError = function (data, arg) {
        if (this.isClose) return;
        this.dispatchEvent(new Event(__WEBPACK_IMPORTED_MODULE_7__event_LoadEvent__["a" /* default */].LOADERROR, [{ code: __WEBPACK_IMPORTED_MODULE_8__ErrCode__["a" /* default */].VOD_CONFIG_IO, errInfo: "url:" + this.getUrl() }, arg]));
    };
    return cloudVodProxy;
}();
